# The data belongs to https://kingofhappyhour.com/phoenix/
import pandas as pd
import requests
...
places = []
ref = []
# All the features coming from the king of happy hour Phoenix
with open('C:\\Users\\jorda\\Desktop\\Upwork Proyecto\\phoenix.html', 'r', encoding='iso-8859-1') as f:
    contenido = f.read()
...
df.to_excel("King Happy Hour Phoenix.xlsx")
df.to_csv("King Happy Hour Phoenix.csv")